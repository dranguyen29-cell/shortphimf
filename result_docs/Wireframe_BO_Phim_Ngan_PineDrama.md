...
### MÀN HÌNH 1: MODAL TẠO MỚI & CHỈNH SỬA CHI TIẾT BỘ PHIM (QUẢN LÝ TẬP & TRẠNG THÁI)
```
+---------------------------------------------------------------------------------------------------+
| 🎬 ✏️ CHỈNH SỬA BỘ PHIM: Cô Vợ Sát Thủ & Tổng Tài Bá Đạo (DRAMA-9901)                        [X]  |
+---------------------------------------------------------------------------------------------------+
| 🏷️ 1. THÔNG TIN CHUNG                                                                             |
| TÊN BỘ PHIM (*): [ Cô Vợ Sát Thủ & Tổng Tài Bá Đạo ]        LOẠI HÌNH: (•) Phim Bộ   ( ) Phim Lẻ  |
| POSTER ĐẠI DIỆN: [🖼️ Preview]  Link URL: [ https://example.com/poster.jpg                      ] |
| GÁN THỂ LOẠI:    [❤️ Ngôn Tình ✕]  [👑 Tổng Tài ✕]  | 🔍 Tìm thể loại...                         ▼|
+---------------------------------------------------------------------------------------------------+
| 🎬 2. DANH SÁCH TẬP                              [➕ Thêm Phần Mới (Season)]   [🗑️ Xóa Phần Này]  |
| [🎬 Phần 1 (5 Tập)]   [🎬 Phần 2 (2 Tập)]                                                         |
|                                                                                                   |
| ┌─ GÁN LINK HÀNG LOẠT (BULK URL IMPORTER) ──────────────────────────────────────────────────────┐ |
| │ Bắt đầu từ tập số: [ 1 ]                                                                      │ |
| │ [Dán danh sách các link stream m3u8 vào đây, 1 dòng 1 link.................................] │ |
| │                                                                                [⚡ Gán Phim]   │ |
| └───────────────────────────────────────────────────────────────────────────────────────────────┘ |
|                                                                                                   |
| TẬP PHIM (5 Tập):                                                                [➕ Thêm Tập Mới]|
| ┌───────────────────────────────────────────────────────────────────────────────────────────────┐ |
| │ THỨ TỰ   TÊN TẬP PHIM           LINK URL                   TRẠNG THÁI               HÀNH ĐỘNG │ |
| │  ⠿ #1    [Tập 1: Định Mệnh Gặp] [https://.../ep1.m3u8]     [ [O] 🟢 Xuất bản ]       [▶️] [🗑️] │ |
| │  ⠿ #2    [Tập 2: Thân Phận Bị ] [https://.../ep2.m3u8]     [ [O] 🟢 Xuất bản ]       [▶️] [🗑️] │ |
| │  ⠿ #3    [Tập 3: Cạm Bẫy Hào M] [https://.../ep3_broken] ⚠️ [ [ ] 🔴 Tạm ẩn   ]       [▶️] [🗑️] │ |
| │  ⠿ #4    [Tập 4: Phản Kích Bất] [https://.../ep4.m3u8]     [ [O] 🟢 Xuất bản ]       [▶️] [🗑️] │ |
...
+-------------------------------------------------------------------------------------------------------------------------------+
| STT  POSTER  TÊN BỘ PHIM & ID    THỂ LOẠI     LƯỢT XEM  ❤️ LIKE                                         |
| #1   [VCLK]  Vợ Cũ Lật Kèo (80T) Ngôn Tình    342,000   28,400                                          |
| #2   [MCSC]  Mẹ Chồng Siêu Cấp   Gia Đình     285,000   24,100                                          |
| #3   [HDHN]  Hợp Đồng Hôn Nhân   Tổng Tài     210,000   31,200                                          |
| #4   [HMTH]  Hào Môn Trả Thù     Trả Thù      198,000   36,500(⭐)                                      |
| #5   [CVST]  Cô Vợ Sát Thủ       Ngôn Tình    165,000   19,800                                          |
+-------------------------------------------------------------------------------------------------------------------------------+
```
